...
| Skill | Description |
|-------|-------------|
| [agent-docs-writer](skills/agent-docs-writer/SKILL.md) | Use this skill when writing/editing any agent markdown files (skills, rules, configs, etc.) |
| [agent-skill-writer](skills/agent-skill-writer/SKILL.md) | Use this skill when writing/editing skills |
...
| [committer](skills/committer/SKILL.md) | User this skill to commit and push changes to git repo and create pull request if needed. |
| [game-player](skills/game-player/SKILL.md) | This skill tells you how to play a game properly |
| [mweb-database-guide](skills/mweb-database-guide/SKILL.md) | Provides knowledge about MWeb's SQLite database schema and table relationships |
...
| [mweb-structure-guide](skills/mweb-structure-guide/SKILL.md) | Provides knowledge about MWeb document and media file organization structure |
| [mweb-to-obsidian](skills/mweb-to-obsidian/SKILL.md) | Use this skill to migrate MWeb data to Obsidian |

---

*This document was automatically generated based on commit [`d07a294a28104f5c57889d771485bd77aa4cafef`](https://github.com/highestop/.claude/commit/d07a294a28104f5c57889d771485bd77aa4cafef).*
