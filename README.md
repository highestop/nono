...
| Skill | Description |
|-------|-------------|
| agent-docs-writer | Use this skill when writing/editing any agent markdown files (skills, rules, configs, etc.) |
...
| mweb-structure-guide | Provides knowledge about MWeb document and media file organization structure |
| mweb-to-obsidian | Use this skill to migrate MWeb data to Obsidian |
